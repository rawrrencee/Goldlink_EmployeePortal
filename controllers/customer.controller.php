...
class CustomerController
{
    ...
    public static function ctrCreateCustomer()
    {
        if (isset($_POST["newFirstName"])) {
            ...
            $submittedForm['chinese_name'] = filter_var($_POST["newChineseName"], FILTER_SANITIZE_STRING);
            ...
            $submittedForm['email'] = filter_var($_POST["newEmail"], FILTER_SANITIZE_STRING);
            ...
            $submittedForm['nric'] = filter_var($_POST["newCustomerNRIC"], FILTER_SANITIZE_STRING);
            $submittedForm['title'] = filter_var($_POST["newTitle"], FILTER_SANITIZE_STRING);
            ...
            $submittedForm['preferred_contact'] = filter_var($_POST["newPreferredContact"], FILTER_SANITIZE_STRING);
            $submittedForm['discount'] = filter_var($_POST["newDiscount"], FILTER_SANITIZE_STRING);
            $submittedForm['dunhill_discount'] = $emptyString;
            $submittedForm['store'] = filter_var($_POST["newStoreSelection"], FILTER_SANITIZE_STRING);
    ...
    public static function ctrEditCustomer()
    {
        if (isset($_POST["editCustomerId"])) {
            ...
            $submittedForm['chinese_name'] = filter_var($_POST["editChineseName"], FILTER_SANITIZE_STRING);
            ...
            $submittedForm['email'] = filter_var($_POST["editEmail"], FILTER_SANITIZE_STRING);
            ...
            $submittedForm['emergency_address'] = $emptyString;
            $submittedForm['emergency_contact'] = $emptyString;
            $submittedForm['nric'] = filter_var($_POST["editCustomerNRIC"], FILTER_SANITIZE_STRING);
            $submittedForm['title'] = filter_var($_POST["editTitle"], FILTER_SANITIZE_STRING);
            $submittedForm['company_name'] = filter_var($_POST["editCompanyName"], FILTER_SANITIZE_STRING);
            $submittedForm['designation'] = filter_var($_POST["editDesignation"], FILTER_SANITIZE_STRING);
            $submittedForm['nationality'] = filter_var($_POST["editNationality"], FILTER_SANITIZE_STRING);
            ...
            $submittedForm['preferred_contact'] = filter_var($_POST["editPreferredContact"], FILTER_SANITIZE_STRING);
            $submittedForm['discount'] = filter_var($_POST["editDiscount"], FILTER_SANITIZE_STRING);
            $submittedForm['dunhill_discount'] = $emptyString;
            $submittedForm['store'] = filter_var($_POST["editStoreSelection"], FILTER_SANITIZE_STRING);
