            ...
            <div class="box-header with-border">
                ...
                <div class="col-md-10 col-xs-12">
                    <div class="box-tools pull-right">
                        ...
                        <button id="redrawTeamSalaryVouchersTable" class="btn btn-info" style="margin-top: 10px;">Reset</button>
                    </div>
                </div>
            </div>
            ...
            <div class="box-body">
                <div class="col-md-12 col-sm-12 col-xs-12" style="overflow-y: auto; overflow-x: auto; width: 100%;">
                    <form id="updateVoucherStatusForm" role="form" method="POST" action="#">
                        ...
                        <table
                            class="table table-hover table-bordered table-striped dt-responsive tableTeamSalaryVouchers"
                            width="100%">
                            <thead>
                                <tr>
