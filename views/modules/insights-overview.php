                                            ...
                                            <div class="row">
                                                <div class="col-md-12 col-sm-12 col-xs-12">
                                                    <div style="text-align: center;">
                                                        <h6>This month's</h4>
                                                            <h4><b>Highest Store Sales</b></h4>
                                                    </div>
                                                </div>
                                                <div class="col-md-12 col-sm-12 col-xs-12">
                                                    <div id="thisMonthHighestStoreData" style="text-align: center;">
                                                        <h3 style=" margin-top: 20px;">TE (Taka)</h3>
                                                        <h4 style="width: 100%;">$20310.00&nbsp;<i
                                                ...
                                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                    ...
                                                    <div class="row" style="margin-top: 20px;">
                                                        ...
                                                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12"
                                                            ...
                                                            <h5 class="text-success">Decrease order amount</h5>
                                                        </div>
                                                    </div>
