        ...
        <div class="box">
            <div class="box-header with-border">
                ...
                <div class="col-md-10 col-xs-12">
                    <div class="box-tools pull-right">
                        ...
                        <select id="dataTablesFilterCustomerArchivesByStore" class="select2">
                            <?php
                                $item = null;
                                $value = null;

                                $stores = StoreController::ctrViewAllStoreCodes($item, $value);

                                foreach ($stores as $key => $value) {
                                echo '<option value ="' . $value["store"] . '">' . $value["store"] . '</option>';
                                }
                            ?>
                        </select>
                    </div>
            ...
            <div class="box-body">
                <div class="col-md-12" style="overflow-y: auto;">
                    <table class="table table-hover table-bordered table-striped dt-responsive tableCustomerArchives"
                        width="100%">
                        <thead>
                            <tr>
                                <th>Store</th>
