                ...
                <div class="box-body">
                    <form role="form" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-6">
                                <input type="checkbox" class="minimal" id="newCRUDEmployeeInfo" name="allowedModules[0]"
                                    value="employee-management">
                                <p style="margin-top: 5px;">View/Create/Update/Delete Employee Information</p>
                            </div>
                            <div class="form-group col-md-6">
                                <input type="checkbox" class="minimal" id="newUploadEmployeeDocs" name="allowedModules[1]"
                                    value="employee-upload-files">
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-6">
                                <input type="checkbox" class="minimal" id="newSalaryVoucherMgt" name="allowedModules[2]"
                                    value="employee-salary-voucher-management">
                                <p style="margin-top: 5px;">View/Update/Approve/Reject/Download <strong>ALL</strong> Salary Vouchers</p>
                            </div>
                            <div class="form-group col-md-6">
                                <input type="checkbox" class="minimal" id="newViewOwnSalaryVoucher" name="allowedModules[3]"
                                    value="employee-salary-voucher-view">
                                <p style="margin-top: 5px;">View <strong>OWN</strong> Salary Vouchers</p>
                            </div>
                            <div class="form-group col-md-6">
                                <input type="checkbox" class="minimal" id="newDownloadOwnSalaryVoucher" name="allowedModules[4]"
                                    value="employee-salary-voucher-download">
                                <p style="margin-top: 5px;">Download <strong>OWN</strong> Salary Vouchers</p>
                            </div>
                            <div class="form-group col-md-6">
                                <input type="checkbox" class="minimal" id="newSubmitOwnSalaryVoucher" name="allowedModules[5]"
                        ...
                        <div class="box-body">
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" class="form-control" id="editBankAccNum" name="editBankAccNum">
                                </div>
                                <div class="form-group col-md-6">
